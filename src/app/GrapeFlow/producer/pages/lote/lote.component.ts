  ...
  export class LoteComponent implements OnInit, AfterViewInit {
    protected columnsToDisplay: string[] = ['numeroLote', 'uva', 'fechaInicio', 'estadoProceso', 'actions'];
    ...
    onDelete(lote: Lote): void {
      if (confirm(`¿Estás seguro de que quieres eliminar el lote ${lote.numeroLote}?`)) {
